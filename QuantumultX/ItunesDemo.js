...
>「 脚本名称 」         Itunes类软件单个解锁模版
>「 脚本作者 」         M̆̈̆̈ĭ̈̆̈k̆̈̆̈ĕ̈
>「 电报频道 」         https://t.me/TrollStoreKios 
>「 更新时间 」         2024-10-26
>「 注意事项 」         如需引用请注明出处，谢谢合作！
>「 注意事项 」         使用此脚本，会导致AppleStore无法切换账户，解决方法[关闭QX切换账户，或关闭MITM，或删除脚本，或去设置媒体与购买项目处切换ID]
>「 额外说明 」         product_id填的内容必须相同
>「 额外说明 」         请勿传播或售卖此脚本

[rewrite_local]
^https?:\/\/buy\.itunes\.apple\.com\/(verifyReceipt|analytics\/profile|receipt\/validate|verify|purchase)$ url script-response-body https://raw.githubusercontent.com/Mike-offers/Rewrite/refs/heads/master/QuantumultX/ItunesDemo.js
  ...
  "pending_renewal_info": [
    {
      "product_id": "",//这里替换成你要解锁的产品id
      "original_transaction_id": "220002179016924",
      "auto_renew_product_id": "",//这里替换成你要解锁的产品id
      "auto_renew_status": "1"
    }
  ],
  "status": 0,

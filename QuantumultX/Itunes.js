...
var ddm1023 = JSON.parse($response.body);
const ua = $request.headers['User-Agent'] || $request.headers['user-agent'];
const bundle_id = ddm1023.receipt["bundle_id"] || ddm1023.receipt["Bundle_Id"];
...
const list = {
  ...
  'IWhiteBoard': { cm: 'timeb', hx: 'hxpda', id: "cn.readpad.tool.iwhiteboard.coffee006", latest: "ddm1023" },  //白板
  'FETreeVideoChange': { cm: 'timeb', hx: 'hxpda', id: "com.dj.videototext.forever", latest: "ddm1023" },  //视频转文字
  ...
  'com.smartgymapp.smartgym': { cm: 'timea', hx: 'hxpda', id: "com.smartgymapp.smartgym.premiumpersonaltraineryearly", latest: "ddm1023" },  //SmartGym
  ...
  'Caculator': { cm: 'timea', hx: 'hxpda', id: "calc_Unlock_1", latest: "ddm1023" },  //计算器+
  ...
  'one%20sec': { cm: 'timeb', hx: 'hxpda', id: "wtf.riedel.onesec.lifetime", latest: "ddm1023" },  //onesec-番茄钟
  ...
  'com.skysoft.removalfree': { cm: 'timea', hx: 'hxpda', id: "com.skysoft.removalfree.subscription.yearly3", latest: "ddm1023" },  //神奇消除笔-图片消除
  ...
  'SoundLab': { cm: 'timea', hx: 'hxpda', id: "8001", latest: "ddm1023" },  //合声
  ...
  'FileArtifact': { cm: 'timea', hx: 'hxpda', id: "com.shengzhou.fileartifact.year", latest: "ddm1023" },  //文晓生
  ...
  'WaterMinder': { cm: 'timea', hx: 'hxpda', id: "waterminder.premiumOnetime", latest: "ddm1023" },  //WaterMinder喝水APP
  ...
  'MagicWidget': { cm: 'timea', hx: 'hxpda', id: "com.sm.widget.Pro", latest: "ddm1023" },  //ColorfulWidget—小组件
  ...
  'WeeklyNote': { cm: 'timea', hx: 'hxpda', id: "org.zrey.weeklynote.yearly", latest: "ddm1023" },  //WeeklyNote(周周记)
  'DoMemo': { cm: 'timea', hx: 'hxpda', id: "org.zrey.fastnote.yearly", latest: "ddm1023" },  //DoMemo
  'CostMemo': { cm: 'timea', hx: 'hxpda', id: "org.zrey.money.yearly", latest: "ddm1023" },  //CostMemo
  'iTimely': { cm: 'timea', hx: 'hxpda', id: "org.zrey.iTimely.yearly", latest: "ddm1023" },  //iTimely
  ...
  'Picsew': { cm: 'timeb', hx: 'hxpdb', id: "com.sugarmo.ScrollClip.pro", latest: "ddm1023" },  //Picsew截长图3.9.4版本(最新版无效)
...
for (const i in list) {
  ...
  if (regex.test(ua) || regex.test(bundle_id)) {
    ...
    if (hx.includes('hxpda')) {
      ddm1023["receipt"]["in_app"] = data;
      ddm1023["latest_receipt_info"] = data;
      ddm1023["pending_renewal_info"] = [{ "product_id": id, "original_transaction_id": "490001314520000", "auto_renew_product_id": id, "auto_renew_status": "1" }];
      ddm1023["latest_receipt"] = latest;
    }
      ...
      ddm1023["receipt"] = Object.assign({}, ddm1023["receipt"], xreceipt);
      ddm1023["latest_receipt_info"] = Object.assign({}, ddm1023["receipt"], xreceipt);
      ddm1023["status"] = 0;
      ddm1023["auto_renew_status"] = 1;
      ddm1023["auto_renew_product_id"] = id;
      delete ddm1023["latest_expired_receipt_info"];
      delete ddm1023["expiration_intent"];
    }
    // 判断是否需要加入版本号
    if (version && version.trim() !== '') { ddm1023["receipt"]["original_application_version"] = version; }
    anchor = true;
...
if (!anchor) {
  ...
  ddm1023["receipt"]["in_app"] = data;
  ddm1023["latest_receipt_info"] = data;
  ddm1023["pending_renewal_info"] = [{ "product_id": yearlyid, "original_transaction_id": "490001314520000", "auto_renew_product_id": yearlyid, "auto_renew_status": "1" }];
  ddm1023["latest_receipt"] = "ddm1023";
  console.log('很遗憾未能识别出UA或bundle_id\n但已使用备用方案操作成功🎉🎉🎉\n叮当猫の分享频道: ddm1023');
}

ddm1023["Telegram"] = "https://t.me/ddm1023";
ddm1023["warning"] = "仅供学习，禁止转载或售卖";

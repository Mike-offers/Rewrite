...
使用声明：⚠️仅供参考，🈲转载与售卖！
额外说明：仅用于个人备份自用，无其他用途！

[rewrite_local]
^https?:\/\/((h5|api)\.xiuxiu|api-sub|api\.posters)\.meitu\.com\/.+\/(vip|user|h\d|center|home) url script-response-body https://raw.githubusercontent.com/Mike-offers/Rewrite/refs/heads/master/QuantumultX/MTXX.js
...
if ($request.url.indexOf(user) != -1){
  ddm1023.data.vip_type = 101;
  ddm1023.data.vip_icon = "https://xximg1.meitudata.com/6948531747980333892.png";
  ddm1023.data.follower_count = 999000;
  ddm1023.data.fan_count = 999000;
  ddm1023.data.be_like_count = 999000;
}

if ($request.url.indexOf(hyzl) != -1){
  delete ddm1023.data.materials;
  delete ddm1023.data.prices;
  delete ddm1023.data.new_version_rotograms;
  ddm1023.data.vip_sign_info = {
      "sub_type" : 3,
      "renew_status" : 1,
      "show_auto_renew" : 1,
  ...
  ddm1023.data.vip_power_num = 999999;
  ddm1023.data.new_power_num = 999999;
  ddm1023.data.welfare_center_num = 999999;
  ddm1023.data.exchange_vip = 0;
  ddm1023.data.platform = 2;
  ddm1023.data.renew = 1;
  ddm1023.data.is_new_vipsub = 0;
  ddm1023.data.s = 1;
  ddm1023.data.expire_days = -66666;
  ddm1023.data.sub_type = 3;
  ddm1023.data.old_vip_type = 4;
  ddm1023.data.valid_time = 4092599349;
  ddm1023.data.invalid_time = 4092599349;
  ddm1023.data.is_expire = 0;
  ddm1023.data.rights_page_vip_btn_title = "立即解锁";
  ddm1023.data.rights_page_svip_btn_title = "立即解锁";
  ddm1023.data.hbp_vip = {
      "sub_type" : 3,
      "valid_time" : 4092599349,
      "renew" : 1,
      "expire_days" : -66666,
...
if ($request.url.indexOf(hymb) != -1){
  delete ddm1023.data.rights;
  delete ddm1023.data.navigation_card_list;
  delete ddm1023.data.config_list;
  delete ddm1023.data.pendant;
  ddm1023.data.vip_type = 101;
  ddm1023.data.display_vip_time = 1;
  ddm1023.data.display_vip_type = 2;
  ddm1023.data.hbp_vip = {
      "id" : "666666666666666666",
      "id_str" : "666666666666666666",
      "valid_time" : 4092599349,
...
if ($request.url.indexOf(vip) != -1){
  ddm1023.data.vip_end_time = 4092599349;
  ddm1023.data.is_vip = true;
}
